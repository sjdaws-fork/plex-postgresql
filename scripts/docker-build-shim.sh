...
gcc -shared -fPIC -O2 -fno-stack-protector \
    ...
    src/interpose/db_interpose_step.c src/interpose/db_interpose_txn_utils.c src/interpose/db_interpose_step_write_utils.c src/interpose/db_interpose_step_cached_read_utils.c src/interpose/db_interpose_step_read_utils.c src/interpose/db_interpose_column.c \
