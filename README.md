...
[📥 Download v0.9.22](https://github.com/cgnl/plex-postgresql/releases/tag/v0.9.22) | [📋 Full Release Notes](https://github.com/cgnl/plex-postgresql/releases/tag/v0.9.22)
...
**macOS:**
```bash
curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.22/plex-postgresql-v0.9.22-macos.zip \
...
**Linux (x86_64):**
```bash
sudo curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.22/plex-postgresql-v0.9.22-linux.zip \
...
```bash
curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.22/plex-postgresql-v0.9.22-macos.zip -o /tmp/plex-pg-macos.zip
mkdir -p /tmp/plex-pg-macos && cd /tmp/plex-pg-macos
unzip /tmp/plex-pg-macos.zip
...
```bash
curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.22/plex-postgresql-v0.9.22-linux.zip -o /tmp/plex-pg-linux.zip
