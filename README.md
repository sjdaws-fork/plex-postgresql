...
[📥 Download v0.9.30](https://github.com/cgnl/plex-postgresql/releases/tag/v0.9.30) | [📋 Full Release Notes](https://github.com/cgnl/plex-postgresql/releases/tag/v0.9.30)
...
**macOS:**
```bash
curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.30/plex-postgresql-v0.9.30-macos.zip \
...
**Linux (x86_64):**
```bash
sudo curl -L https://github.com/cgnl/plex-postgresql/releases/download/v0.9.30/plex-postgresql-v0.9.30-linux.zip \
